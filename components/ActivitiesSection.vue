<template>
  <main class="grid grid-cols-3 gap-6">
    <div v-for="n in 6" :key="n" class="max-w-lg p-4 shadow-md dark:bg-gray-900 dark:text-gray-100">
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-2">
          <a rel="noopener noreferrer" href="#" class="block">
            <h3 class="text-xl font-semibold dark:text-violet-400">Facere ipsa nulla corrupti praesentium pariatur architecto</h3>
          </a>
